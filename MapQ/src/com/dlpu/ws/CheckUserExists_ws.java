...
public class CheckUserExists_ws {
	...
	private String CheckUsrExistsResult = null;

	public String getCheckUsrExistsResult() {
		return CheckUsrExistsResult;
	}

	// WebService调用,获取用户登录信息
	public void CheckUser(String strUserName) {
		// String endPoint 为方便开发和测试时使用(届时应当除去)

		// 命名空间
		String nameSpace = "http://mapq.com.cn/";
		// 方法
		String methodName = "CheckUserExists";
		// endPoint
		String endPoint = this.theHttpIpString + "/ws/UserServer.asmx";
		// String endPoint = "http://10.0.2.2:8081/ws/UserServer.asmx";//
		// 在安卓虚拟机上调试访问本机IP
		// soapAction
		String soapAction = "http://mapq.com.cn/CheckUserExists";
		...
		this.CheckUsrExistsResult = aString;
	}
}
